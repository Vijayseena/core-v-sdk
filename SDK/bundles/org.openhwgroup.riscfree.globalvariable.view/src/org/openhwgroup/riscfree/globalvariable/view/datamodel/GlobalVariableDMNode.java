 ...
 * 
 */
package org.openhwgroup.riscfree.globalvariable.view.datamodel;
...
public class GlobalVariableDMNode implements IAdaptable, IGlobalVariableDescriptor, Comparable<GlobalVariableDMNode> {
	...
	public GlobalVariableDMNode(String fileName, String fullname, Integer line, String name, String type,
			String description) {
