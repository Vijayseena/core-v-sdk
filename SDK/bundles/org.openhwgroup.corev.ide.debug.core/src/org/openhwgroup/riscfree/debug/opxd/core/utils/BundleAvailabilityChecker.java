...
public class BundleAvailabilityChecker {
	...
	public static final String COMRV_BUNDLE_NAME = "org.openhwgroup.riscfree.debug.overlay.comrv";
	
	public static final String MIPS_BUNDLE_NAME = "org.openhwgroup.riscfree.managedbuild.cross.mips";
	
	public static final String GCOV_BUNDLE_NAME = "org.eclipse.linuxtools.gcov.core";
	
	public static final String OS_AWARENESS_BUNDLE_NAME = "org.openhwgroup.riscfree.debug.osawareness.ui";
	
	public static final String INTEL_BUNDLE_NAME= "org.openhwgroup.riscfree.managedbuild.cross.intelriscv.core";

	public static final String OPXD_ARC_BUNDLE_NAME= "org.openhwgroup.riscfree.debug.opxd.arc";
	
	public static final String OPXD_ARM_BUNDLE_NAME= "org.openhwgroup.riscfree.debug.opxd.arm";
