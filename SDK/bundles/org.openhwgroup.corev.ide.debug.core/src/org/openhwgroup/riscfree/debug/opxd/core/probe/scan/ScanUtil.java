...
import org.openhwgroup.riscfree.debug.opxd.core.scanchain.ScanChain;
 ...
 *  package test;
 *  
 *  import org.openhwgroup.pf.tm.utils.probe.DebugProbe;
 *  import org.openhwgroup.pf.tm.utils.probe.ProbeNames;
 *  import org.openhwgroup.pf.tm.utils.scan.ScanUtil;
 *  
...
public class ScanUtil {
	 ...
	 * scanning OpenHW Group debug probes. Will return null if any Exception or Error
	 * occurs
	 * 
	...
	/**
	 * Returns the path of OpenHW Group libraries.
	 * 
	 * @return OpenHW Group library path
	 */
	 ...
	 * 
	 * @param probName the type of OpenHW Group probe to be scanned.
