...
public class devicesPackageImpl extends EPackageImpl implements devicesPackage {
	 ...
	 * @generated
	 */
	private EClass openHWGroupProcessorDataBaseTypeEClass = null;
	 ...
	 * @generated
	 */
	public EClass getopenHWGroupProcessorDataBaseType() {
		return openHWGroupProcessorDataBaseTypeEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getopenHWGroupProcessorDataBaseType_Processor() {
		return (EReference)openHWGroupProcessorDataBaseTypeEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getopenHWGroupProcessorDataBaseType_Date() {
		return (EAttribute)openHWGroupProcessorDataBaseTypeEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getopenHWGroupProcessorDataBaseType_Family() {
		return (EAttribute)openHWGroupProcessorDataBaseTypeEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getopenHWGroupProcessorDataBaseType_SubSet() {
		return (EAttribute)openHWGroupProcessorDataBaseTypeEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getopenHWGroupProcessorDataBaseType_Version() {
		return (EAttribute)openHWGroupProcessorDataBaseTypeEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EReference getDocumentRoot_OpenHWGroupProcessorDataBase() {
	...
	public void createPackageContents() {
		...
		openHWGroupProcessorDataBaseTypeEClass = createEClass(OPEN_HW_GROUP_PROCESSOR_DATA_BASE_TYPE);
		createEReference(openHWGroupProcessorDataBaseTypeEClass, OPEN_HW_GROUP_PROCESSOR_DATA_BASE_TYPE__PROCESSOR);
		createEAttribute(openHWGroupProcessorDataBaseTypeEClass, OPEN_HW_GROUP_PROCESSOR_DATA_BASE_TYPE__DATE);
		createEAttribute(openHWGroupProcessorDataBaseTypeEClass, OPEN_HW_GROUP_PROCESSOR_DATA_BASE_TYPE__FAMILY);
		createEAttribute(openHWGroupProcessorDataBaseTypeEClass, OPEN_HW_GROUP_PROCESSOR_DATA_BASE_TYPE__SUB_SET);
		createEAttribute(openHWGroupProcessorDataBaseTypeEClass, OPEN_HW_GROUP_PROCESSOR_DATA_BASE_TYPE__VERSION);
		...
		createEReference(documentRootEClass, DOCUMENT_ROOT_OPEN_HW_GROUP_PROCESSOR_DATA_BASE);
	...
	public void initializePackageContents() {
		...
		initEClass(openHWGroupProcessorDataBaseTypeEClass, OpenHWGroupProcessorDataBaseType.class, "openHWGroupProcessorDataBaseType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getopenHWGroupProcessorDataBaseType_Processor(), this.getProcessorType(), null, "processor", null, 1, -1, OpenHWGroupProcessorDataBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getopenHWGroupProcessorDataBaseType_Date(), theXMLTypePackage.getDate(), "date", null, 1, 1, OpenHWGroupProcessorDataBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getopenHWGroupProcessorDataBaseType_Family(), theXMLTypePackage.getString(), "family", null, 1, 1, OpenHWGroupProcessorDataBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getopenHWGroupProcessorDataBaseType_SubSet(), theXMLTypePackage.getString(), "subSet", null, 1, 1, OpenHWGroupProcessorDataBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getopenHWGroupProcessorDataBaseType_Version(), theXMLTypePackage.getUnsignedByte(), "version", null, 1, 1, OpenHWGroupProcessorDataBaseType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDocumentRoot_OpenHWGroupProcessorDataBase(), this.getopenHWGroupProcessorDataBaseType(), null, "openHWGroupProcessorDataBase", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (openHWGroupProcessorDataBaseTypeEClass,
		   source,
		   new String[] {
			   "name", "OpenHWGroupProcessorDataBase_._type",
			   "kind", "elementOnly"
		   });
		addAnnotation
		  (getopenHWGroupProcessorDataBaseType_Processor(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "Processor",
		...
		addAnnotation
		  (getopenHWGroupProcessorDataBaseType_Date(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "Date",
		...
		addAnnotation
		  (getopenHWGroupProcessorDataBaseType_Family(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "Family",
		...
		addAnnotation
		  (getopenHWGroupProcessorDataBaseType_SubSet(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "SubSet",
		...
		addAnnotation
		  (getopenHWGroupProcessorDataBaseType_Version(),
		   source,
		   new String[] {
			   "kind", "attribute",
			   "name", "Version",
		...
		addAnnotation
		  (getDocumentRoot_OpenHWGroupProcessorDataBase(),
		   source,
		   new String[] {
			   "kind", "element",
			   "name", "OpenHWGroupProcessorDataBase",
			   "namespace", "##targetNamespace"
		   });
		addAnnotation
		  (jtagdpTypeEClass,
