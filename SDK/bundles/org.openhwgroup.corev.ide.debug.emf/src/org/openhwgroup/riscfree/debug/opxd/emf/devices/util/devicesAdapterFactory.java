...
public class devicesAdapterFactory extends AdapterFactoryImpl {
	...
	protected devicesSwitch<Adapter> modelSwitch =
		new devicesSwitch<Adapter>() {
			...
			@Override
			public Adapter caseopenHWGroupProcessorDataBaseType(OpenHWGroupProcessorDataBaseType object) {
				return createopenHWGroupProcessorDataBaseTypeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link OpenHWGroupProcessorDataBaseType.openHWGroupProcessorDataBaseType <em>OpenHW Group Processor Data Base Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see OpenHWGroupProcessorDataBaseType.openHWGroupProcessorDataBaseType
	 * @generated
	 */
	public Adapter createopenHWGroupProcessorDataBaseTypeAdapter() {
		return null;
	}
