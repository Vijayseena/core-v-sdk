/**
 */
package org.openhwgroup.riscfree.debug.opxd.emf.devices.util;
...
public class devicesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case devicesPackage.OPEN_HW_GROUP_PROCESSOR_DATA_BASE_TYPE: {
				OpenHWGroupProcessorDataBaseType openHWGroupProcessorDataBaseType = (OpenHWGroupProcessorDataBaseType)theEObject;
				T result = caseopenHWGroupProcessorDataBaseType(openHWGroupProcessorDataBaseType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>OpenHW Group Processor Data Base Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>OpenHW Group Processor Data Base Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseopenHWGroupProcessorDataBaseType(OpenHWGroupProcessorDataBaseType object) {
		return null;
	}
